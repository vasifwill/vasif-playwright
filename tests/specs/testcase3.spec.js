...
// Confirm tag: "Design".
test.describe('Test Case 3 – In Progress Board Verification', () => {
  ...
  test('Login and verify "Design system updates" card and tags', async ({ page }) => {
    ...
    const inProgressColumn = page.locator('div', {
      has: page.getByRole('heading', { level: 2, name: /In Progress/i })
    });

    // 4 Locate the specific "Design system updates" card inside "In Progress"
