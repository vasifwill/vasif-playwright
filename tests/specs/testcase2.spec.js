...
// Confirm tag: "Bug".
test.describe('Test Case 2 – To Do Board Verification', () => {
  ...
  test('Login and verify "Fix navigation bug" card and tags', async ({ page }) => {
    ...
    // 4 Locate the specific card "Fix navigation bug" inside "To Do"
    ...
    // 5 Verify card title "Fix navigation bug" is visible
